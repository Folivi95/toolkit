...
var jsonTests = []struct {
	...
	{name: "unknown field in json", json: `{"foooooo": "1"}`, errorExpected: true, maxSize: 1024, allowUnknown: false},
	{name: "allow unknown fields in json", json: `{"foooooo": "1"}`, errorExpected: false, maxSize: 1024, allowUnknown: true},
...
func TestTools_RandomString(t *testing.T) {
	...
	if len(s) != 10 {
		t.Error("random string returned wrong length of string")
	}
}
